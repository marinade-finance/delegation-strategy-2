...
lazy_static! {
    ...
    .unwrap();
    pub static ref REQUEST_COUNT_VALIDATOR_SCORE_BREAKDOWNS: IntCounter = register_int_counter!(
        "ds_request_count_validator_score_breakdowns",
        "How many times /validators/score-breakdowns endpoint was requested"
    )
    .unwrap();
